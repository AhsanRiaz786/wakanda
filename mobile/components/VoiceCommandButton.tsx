        ...
        <View style={styles.feedbackContainer}>
          {isProcessing && (
            <View style={styles.processingRow}>
              ...
              <Typography variant="body" color={colors.green} style={styles.processingText}>
                Processing command...
              </Typography>
            </View>
          )}
          ...
          {error && (
            <Typography variant="body" color={colors.crit} style={styles.errorText}>
              {error}
            </Typography>
          )}
          ...
          {transcript && !isProcessing && (
            <View style={styles.resultBlock}>
              ...
              <Typography variant="body" color={colors.textMuted} style={styles.transcriptText}>
                "{transcript}"
              </Typography>
            </View>
          )}
      ...
      <View style={styles.buttonWrapper}>
        {isRecording && (
          <View style={styles.recordingHintBox}>
            ...
            <Typography variant="mono" color={colors.green} style={styles.recordingHint}>
              LISTENING
            </Typography>
          </View>
        )}
        ...
        >
          <Mic
            size={28}
            color={isRecording ? colors.bg : colors.green}
...
const makeStyles = (colors: any, isDark: boolean) => StyleSheet.create({
  ...
  recordingHintBox: {
    flexDirection: 'row',
    alignItems: 'center',
    backgroundColor: 'rgba(31, 181, 94, 0.15)',
    paddingHorizontal: 12,
    paddingVertical: 6,
    borderRadius: 20,
    borderWidth: 1,
    borderColor: 'rgba(31, 181, 94, 0.3)',
    gap: 6,
  },
  pulseDot: {
    width: 6,
